...
var mainSlider = new Swiper(".main-slider .swiper-container", {
   ...
   var power = new Swiper(".power-slider .swiper-container", {
    loop: true,
    autoplay: true,
    pagination: {
        el: ".power-slider .swiper-pagination",
        clickable: true,
    },
    navigation: {
        nextEl: ".power-slider .swiper-btn-next",
        prevEl: ".power-slider .swiper-btn-prev",
    },
    breakpoints: {
        0: {
            slidesPerView: 2,
